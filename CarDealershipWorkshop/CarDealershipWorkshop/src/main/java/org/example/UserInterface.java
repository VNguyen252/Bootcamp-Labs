...
public class UserInterface {
   ...
   //Process Get By Mileage
    ...
    public void leaseVehicle() {
        ...
        System.out.println("Leasing a car? Too broke to buy? Just playing around, let's get started.");
        ...
        if (vehicle == null) {
            System.out.println("We couldn't find anything, MAKE SENSE!!");
            return;
        }

        System.out.println("Let's move on to the details.");
        System.out.println("Enter the contract date (YYYYMMDD):");
        String dateOfContract = scanner.nextLine();
        ...
        System.out.println("We now possess the contract to your first born. Enjoy your new ride!");
        dealership.removeVehicle(vehicle);
    }
}